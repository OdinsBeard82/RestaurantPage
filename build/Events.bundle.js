...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createMenu1: () => (/* binding */ createMenu1)\n/* harmony export */ });\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_modules_tab2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/modules/tab2.js */ \"./src/modules/tab2.js\");\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_modules_tab3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/modules/tab3.js */ \"./src/modules/tab3.js\");\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/index.js */ \"./src/index.js\");\n\n\n\n\nfunction createMenu1() {\n  // Create the menu container\n  const menuContainer = document.createElement('div');\n  menuContainer.classList.add('menu');\n\n  // Create the new page button\n  const newPageButton = document.createElement('button');\n  newPageButton.textContent = 'Menu';\n  newPageButton.classList.add('newPage-button');\n  menuContainer.appendChild(newPageButton);\n\n  // Append the menu container to the document body\n  document.body.appendChild(menuContainer);\n\n  // Event listener for button click to toggle new page\n  newPageButton.addEventListener('click', () => {\n    // Clear the document body\n    document.body.innerHTML = '';\n\n\n    // Call the other menu creation functions\n    (0,_Users_danielturbak_charles_RestaurantPage_src_modules_tab2_js__WEBPACK_IMPORTED_MODULE_0__.createMenu2)();\n    (0,_Users_danielturbak_charles_RestaurantPage_src_modules_tab3_js__WEBPACK_IMPORTED_MODULE_1__.createMenu3)();\n    (0,_Users_danielturbak_charles_RestaurantPage_src_index_js__WEBPACK_IMPORTED_MODULE_2__.createMenu4)();\n\n    // Create elements for the new page\n    const menuPage = document.createElement('div');\n    const menuTitle = document.createElement('h1');\n    menuTitle.textContent = 'Food in Valhalla';\n    const menuContent = document.createElement('p');\n    menuContent.textContent = 'Insert your menu content here.';\n    const menuImage = document.createElement('img');\n    menuImage.src = '/Users/danielturbak-charles/RestaurantPage/src/assets/menu.jpg';\n    menuImage.alt = 'Description of the image';\n\n    // Append elements to the new page\n    menuPage.appendChild(menuTitle);\n    menuPage.appendChild(menuContent);\n    menuPage.appendChild(menuImage);\n\n    // Append the new page to the document body\n    document.body.appendChild(menuPage);\n  });\n}\n\n\n//# sourceURL=webpack://restaurantpage/./src/modules/tab1.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createMenu2: () => (/* binding */ createMenu2)\n/* harmony export */ });\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_modules_tab1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/modules/tab1.js */ \"./src/modules/tab1.js\");\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_modules_tab3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/modules/tab3.js */ \"./src/modules/tab3.js\");\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/index.js */ \"./src/index.js\");\n\n\n\n\nfunction createMenu2() {\n    // Create the menu container\n    const drinksContainer = document.createElement('div');\n    drinksContainer.classList.add('drinks');\n  \n    // Create the new page button\n    const newPageButton = document.createElement('button');\n    newPageButton.textContent = 'Drinks';\n    newPageButton.classList.add('newPage-button');\n    drinksContainer.appendChild(newPageButton);\n  \n    // Append the menu container to the document body\n    document.body.appendChild(drinksContainer);\n  \n    // Event listener for button click to toggle dropdown content\n    newPageButton.addEventListener('click', () => {\n        // Clear the document body\n    document.body.innerHTML = '';\n\n          // Call the other menu creation functions\n          (0,_Users_danielturbak_charles_RestaurantPage_src_modules_tab1_js__WEBPACK_IMPORTED_MODULE_0__.createMenu1)();\n          (0,_Users_danielturbak_charles_RestaurantPage_src_modules_tab3_js__WEBPACK_IMPORTED_MODULE_1__.createMenu3)();\n           (0,_Users_danielturbak_charles_RestaurantPage_src_index_js__WEBPACK_IMPORTED_MODULE_2__.createMenu4)();\n\n       // Create elements for the new page\n       const menuPage = document.createElement('div');\n       const menuTitle = document.createElement('h1');\n       menuTitle.textContent = 'Drinks in Valhalla';\n       const menuContent = document.createElement('p');\n       menuContent.textContent = 'Insert your menu content here.';\n       const menuImage = document.createElement('img');\n       menuImage.src = '/Users/danielturbak-charles/RestaurantPage/src/assets/drinks.jpg';\n       menuImage.alt = 'Description of the image';\n   \n       // Append elements to the new page\n       menuPage.appendChild(menuTitle);\n       menuPage.appendChild(menuContent);\n       menuPage.appendChild(menuImage);\n   \n       // Append the new page to the document body\n       document.body.appendChild(menuPage);\n\n       // Call the other menu creation functions\n    (0,_Users_danielturbak_charles_RestaurantPage_src_modules_tab1_js__WEBPACK_IMPORTED_MODULE_0__.createMenu1)();\n    (0,_Users_danielturbak_charles_RestaurantPage_src_modules_tab3_js__WEBPACK_IMPORTED_MODULE_1__.createMenu3)();\n  });\n}\n\n//# sourceURL=webpack://restaurantpage/./src/modules/tab2.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createMenu3: () => (/* binding */ createMenu3)\n/* harmony export */ });\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_modules_tab1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/modules/tab1.js */ \"./src/modules/tab1.js\");\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_modules_tab2_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/modules/tab2.js */ \"./src/modules/tab2.js\");\n/* harmony import */ var _Users_danielturbak_charles_RestaurantPage_src_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/index.js */ \"./src/index.js\");\n\n\n\n\nfunction createMenu3() {\n    // Create the menu container\n    const eventsContainer = document.createElement('div');\n    eventsContainer.classList.add('events');\n  \n    // Create the new page button\n    const newPageButton = document.createElement('button');\n    newPageButton.textContent = 'Events';\n    newPageButton.classList.add('newPage-button');\n    eventsContainer.appendChild(newPageButton);\n  \n    // Append the menu container to the document body\n    document.body.appendChild(eventsContainer);\n  \n    // Event listener for button click to toggle dropdown content\n    newPageButton.addEventListener('click', () => {\n               // Clear the document body\n    document.body.innerHTML = '';\n\n    // Call the other menu creation functions\n    (0,_Users_danielturbak_charles_RestaurantPage_src_modules_tab1_js__WEBPACK_IMPORTED_MODULE_0__.createMenu1)();\n    (0,_Users_danielturbak_charles_RestaurantPage_src_modules_tab2_js__WEBPACK_IMPORTED_MODULE_1__.createMenu2)();\n    (0,_Users_danielturbak_charles_RestaurantPage_src_index_js__WEBPACK_IMPORTED_MODULE_2__.createMenu4)();\n\n   \n    // Create elements for the new page\n    const menuPage = document.createElement('div');\n    const menuTitle = document.createElement('h1');\n    menuTitle.textContent = 'Events in Valhalla';\n    const menuContent = document.createElement('p');\n    menuContent.textContent = 'Insert your menu content here.';\n    const menuImage = document.createElement('img');\n    menuImage.src = '/Users/danielturbak-charles/RestaurantPage/src/assets/events.jpg';\n    menuImage.alt = 'Description of the image';\n   \n    // Append elements to the new page\n    menuPage.appendChild(menuTitle);\n    menuPage.appendChild(menuContent);\n    menuPage.appendChild(menuImage);\n   \n    // Append the new page to the document body\n    document.body.appendChild(menuPage);\n  });\n}\n\n//# sourceURL=webpack://restaurantpage/./src/modules/tab3.js?");

/***/ }),

/***/ "./src/assets/ThorsHammer.jpg":
/*!************************************!*\
  !*** ./src/assets/ThorsHammer.jpg ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"4100313fea2f20788883.jpg\";\n\n//# sourceURL=webpack://restaurantpage/./src/assets/ThorsHammer.jpg?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/modules/tab3.js");
/******/ 	
/******/ })()
;